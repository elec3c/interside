...
import { js, scripts } from "./gulp/task/js.js";
...
function watcher() {
    ...
    gulp.watch(path.watch.js_libs, scripts);
...
const mainTask = gulp.series(fontsAll, gulp.parallel(copy, dir_root, html, scss, styles, js, scripts, images, svgSprive));
