{set $preTitle = $_modx->resource.longtitle ?: $_modx->resource.pagetitle}
...
<meta property="og:title" content="{$preTitle}" />
...
<link href="/assets/styles/libs.min.css" rel="stylesheet">
